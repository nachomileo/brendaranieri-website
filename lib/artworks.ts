...
const preferredCovers: Record<string, string> = {
  "la-forma-del-agua-quieta-obra": "3_La forma del agua quieta_BrendaRanieri_vertical.png",
  "lo-atamos-con-alambre-obra": "IMG_1733.jpeg",
};
const withImages = (slug: string) => {
  const ordered = [...(images[slug] ?? [])];
  const preferredIndex = ordered.findIndex((image) => image.source === preferredCovers[slug]);
  if (preferredIndex > 0) ordered.unshift(...ordered.splice(preferredIndex, 1));
  return ordered.map((image) => ({ ...image, src: `/images/artworks/${slug}/${image.file}` }));
};

const artworkRecords: Artwork[] = [
  { slug: "terra", title: "Terra", year: "2026", material: "Pasta refractaria, ladrillo machacado y metal", dimensions: "—", edition: "Pieza única", className: "object-1", kind: "single", images: withImages("terra") },
  ...
  { slug: "black-collection", title: "Black collection", year: "2025–2026", material: "Pasta refractaria y esmaltes de formulación propia", dimensions: "Dimensiones variables", edition: "Familia de piezas únicas", className: "object-4", kind: "family", images: withImages("black-collection") },
  ...
  { slug: "materia-solidificandose", title: "Materia solidificándose, límite ablandándose", year: "2026", material: "Arcilla Carabanchel, arcilla Segovia, metal y restos de esmalte", dimensions: "17 × 15 cm", edition: "Piezas únicas", className: "object-2", kind: "family", images: withImages("materia-solidificandose") },
  ...
  { slug: "vasija-con-piedras-2", title: "Vasija con piedras II", year: "2026", material: "Pasta refractaria y piedras naturales", dimensions: "—", edition: "Pieza única", className: "object-6", kind: "single", images: withImages("vasija-con-piedras-2") },
  { slug: "vasija-arcilla-local", title: "Vasija de arcilla local", year: "2025–2026", material: "Arcillas locales y pizarra", dimensions: "—", edition: "Pieza única", className: "object-1", kind: "single", images: withImages("vasija-arcilla-local") },
  ...
  { slug: "sin-titulo-i", title: "Sin título I", year: "2026", material: "Arcilla local y metal", dimensions: "—", edition: "Pieza única", className: "object-4", kind: "single", images: withImages("sin-titulo-i") },
  { slug: "vasija-negra", title: "Vasija negra", year: "2025", material: "Pasta refractaria, piedra natural y esmalte de formulación propia", dimensions: "—", edition: "Pieza única", className: "object-5", kind: "single", images: withImages("vasija-negra") },
  ...
  { slug: "vasija-i", title: "Vasija I", year: "2025", material: "Pasta refractaria, piedras naturales y metal", dimensions: "—", edition: "Pieza única", className: "object-5", kind: "single", images: withImages("vasija-i") },
  ...
  { slug: "vasija-iii", title: "Vasija III", year: "2025–2026", material: "Arcilla local", dimensions: "—", edition: "Pieza única", className: "object-1", kind: "single", images: withImages("vasija-iii") },
  { slug: "figura", title: "Figura", year: "2025", material: "Pasta refractaria, metal y esmalte de formulación propia", dimensions: "—", edition: "Pieza única", className: "object-2", kind: "single", images: withImages("figura") },
  ...
  { slug: "caldero", title: "Caldero", year: "2025", material: "Pasta refractaria, metal y esmalte de formulación propia", dimensions: "—", edition: "Pieza única", className: "object-6", kind: "single", images: withImages("caldero") },
  { slug: "senora-de-hierro", title: "Señora de hierro", year: "2025", material: "Porcelana y metal", dimensions: "—", edition: "Pieza única", className: "object-1", kind: "single", images: withImages("senora-de-hierro") },
  ...
  { slug: "la-forma-del-agua-quieta-obra", title: "La forma del agua quieta", year: "2026", material: "Arcillas locales recolectadas, piedras naturales, esmalte e instalación hidráulica", dimensions: "Dimensiones variables", edition: "Pieza única", className: "object-3", kind: "family", images: withImages("la-forma-del-agua-quieta-obra") },
  ...
  { slug: "lo-velado-obra", title: "Lo velado", year: "2025", material: "Pasta refractaria, esmaltes de formulación propia, metal e instalación hidráulica", dimensions: "—", edition: "Pieza única", className: "object-5", kind: "single", images: withImages("lo-velado-obra") },
  { slug: "lo-atamos-con-alambre-obra", title: "Lo atamos con alambre", year: "2026", material: "Cerámica, hormigón, plástico reciclado, diferentes tipos de metal e instalación hidráulica", dimensions: "70 cm de alto × 73 cm de diámetro", edition: "Pieza única", className: "object-6", kind: "single", images: withImages("lo-atamos-con-alambre-obra") },
...
// A.34 was retired from the public archive. Codes remain tied to the original
// catalogue position so removing an entry never renumbers the remaining works.
export const artworks = artworkRecords.filter((_, index) => index !== 33);
...
export const artworkArchive = archiveOrder.filter((number) => number !== 34).map((number) => artworkRecords[number - 1]);
