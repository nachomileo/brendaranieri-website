  ...
  return <>
    ...
    <main className="about-page about-page-compact">
      <section className="about-profile">
        ...
        <figure className="about-profile-image"><Image src="/images/journal/home/about-portada-interior.webp" alt="Retrato de Brenda Ranieri en su estudio de Carabanchel" fill preload sizes="(max-width: 760px) 100vw, 40vw" quality={85} /></figure>
      </section>
